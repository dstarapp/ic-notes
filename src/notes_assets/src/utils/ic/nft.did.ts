export const idlFactory = ({ IDL }) => {
  ...
  const ERC721 = IDL.Service({
    ...
    getProperties: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Text, IDL.Vec(IDL.Tuple(IDL.Text, IDL.Nat))))], ['query']),
    ...
    getTokensByIds: IDL.Func([IDL.Vec(TokenIndex)], [IDL.Vec(IDL.Tuple(TokenIndex, Metadata))], ['query']),
    getTokensByProperties: IDL.Func([IDL.Vec(IDL.Tuple(IDL.Text, IDL.Vec(IDL.Text)))], [IDL.Vec(IDL.Tuple(TokenIndex, Metadata))], ['query']),
    getTokenspageable: IDL.Func([TokenIndex, TokenIndex], [IDL.Vec(IDL.Tuple(TokenIndex, Metadata))], ['query']),
